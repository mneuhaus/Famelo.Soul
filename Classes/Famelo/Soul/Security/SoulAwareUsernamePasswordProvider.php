<?php
namespace Famelo\Soul\Security;
 ...
 */
class SoulAwareUsernamePasswordProvider extends PersistedUsernamePasswordProvider {
	...
	public function authenticate(TokenInterface $authenticationToken) {
		...
		if (is_object($account)) {
			// if ($account->getParty()->getChain() instanceof UserChain && $account->getParty()->getChain()->hasDeny() === TRUE) {
